window.digiAppSkinning = {
    ...
    secondaryMenu: {
        ...
        bonusBalanceAmountColor: '#EBCC06',
    ...
    mainMenu: {
        ...
        MainMenuItemColorActive: '#EBCC06'
    },
    popup: {
        popupHeaderBackground: '#1A1A1A',
        popupHeaderColor: '#999999',
        popupHeaderUserBalanceColor: '#EBCC06'
    },
    slider: {
        isShadowExist: true,
    ...
    odd: {
        OddBackground: '#262626',
        OddColor: '#FFE63D',
        OddNameColor: '#999999',
        OddBackgroundActive: '#EBCC06',
        OddColorActive: '#1A1A1A',
